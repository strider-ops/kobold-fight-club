 ...
 * Player Levels Data
 *
 * D&D 5e XP thresholds per player level (from DMG p. 82).
 * Defines easy, medium, hard, and deadly encounter difficulties
 * for each character level from 1-20.
 */
...
export const PLAYER_LEVELS: Record<number, PlayerLevelInfo> = {
