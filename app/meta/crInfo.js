/**
 * Challenge Rating Info
 * CR to XP mapping for D&D 5e
 *
 * This file is in AngularJS format for compatibility with build scripts.
 * The canonical source is app/vue/services/monsterFactory.ts (CR_INFO)
 */

(function() {
  'use strict';

  angular.module('app').factory('crInfo', function() {
    return {
